...
<section class="relative w-full min-h-screen bg-gradient-to-b from-black via-neutral-900 to-black text-gray-100 py-24 overflow-hidden mt-[5%]">
  ...
  <div class="max-w-5xl mx-auto px-6 text-center relative z-10">
    <h1 class="text-4xl md:text-5xl font-[Playfair_Display] font-bold text-yellow-400 mb-6 flex justify-center items-center gap-3">
    ...
    <p class="text-gray-300 max-w-2xl mx-auto text-lg leading-relaxed mb-16 font-[Inter]">
  ...
  <div class="max-w-4xl mx-auto bg-gradient-to-br from-neutral-950 to-neutral-900 rounded-3xl border border-yellow-600/30 shadow-[0_0_30px_rgba(212,175,55,0.2)] p-10 md:p-14 mb-20 relative z-10">
    <h2 class="text-3xl font-[Playfair_Display] text-yellow-400 mb-6 flex justify-center items-center gap-3">
    ...
    <p class="text-gray-300 text-lg leading-relaxed font-[Inter] text-center">
  ...
  <div class="max-w-6xl mx-auto px-6 relative z-10 mb-20">
    <h2 class="text-3xl font-[Playfair_Display] text-yellow-400 mb-12 text-center flex justify-center items-center gap-3">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div class="bg-gradient-to-b from-neutral-950 to-neutral-900 border border-yellow-600/20 rounded-2xl shadow-[0_0_20px_rgba(212,175,55,0.15)] hover:shadow-[0_0_30px_rgba(212,175,55,0.25)] transition-all duration-300 p-10 text-center">
        ...
        <h3 class="text-xl font-semibold text-yellow-400 mb-2 font-[Playfair_Display]">บริการเหนือระดับ</h3>
      ...
      <div class="bg-gradient-to-b from-neutral-950 to-neutral-900 border border-yellow-600/20 rounded-2xl shadow-[0_0_20px_rgba(212,175,55,0.15)] hover:shadow-[0_0_30px_rgba(212,175,55,0.25)] transition-all duration-300 p-10 text-center">
        ...
        <h3 class="text-xl font-semibold text-yellow-400 mb-2 font-[Playfair_Display]">ปลอดภัยทุกเส้นทาง</h3>
      ...
      <div class="bg-gradient-to-b from-neutral-950 to-neutral-900 border border-yellow-600/20 rounded-2xl shadow-[0_0_20px_rgba(212,175,55,0.15)] hover:shadow-[0_0_30px_rgba(212,175,55,0.25)] transition-all duration-300 p-10 text-center">
        ...
        <h3 class="text-xl font-semibold text-yellow-400 mb-2 font-[Playfair_Display]">คุ้มค่าทุกการเดินทาง</h3>
  ...
  <div class="max-w-4xl mx-auto bg-gradient-to-br from-neutral-950 to-neutral-900 rounded-3xl border border-yellow-600/30 shadow-[0_0_30px_rgba(212,175,55,0.2)] p-10 text-center relative z-10">
    ...
    <p class="text-gray-300 text-lg leading-relaxed font-[Inter] max-w-3xl mx-auto">
