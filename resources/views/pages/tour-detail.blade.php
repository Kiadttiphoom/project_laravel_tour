...
@section('content')
    ...
    <section class="relative min-h-screen bg-gradient-to-b from-black via-neutral-900 to-black text-gray-100 pt-28 pb-20">
        {{-- Background Glow Effects --}}
        <div class="absolute top-0 left-0 w-[600px] h-[400px] md:h-[600px] bg-gradient-to-br from-yellow-600/30 via-amber-500/20 to-transparent rounded-full blur-3xl animate-pulse"></div>
        <div class="absolute bottom-0 right-0 w-[500px] h-[500px] bg-gradient-to-tr from-yellow-500/25 via-amber-400/15 to-transparent rounded-full blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
        <div class="absolute top-1/3 left-1/3 w-[400px] h-[400px] bg-gradient-to-bl from-amber-600/20 to-transparent rounded-full blur-3xl animate-float-slow"></div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg"
        class="w-3.5 h-3.5 md:w-4 md:h-4 group-hover:scale-110 transition-transform"
    ...
    หน้าแรก
            ...
            <div class="animate-fade-in" style="animation-delay: 0.2s;">
                <div class="rounded-2xl md:rounded-3xl bg-gradient-to-br from-neutral-900/90 via-neutral-900/70 to-black/90 border border-neutral-800/50 shadow-[0_20px_80px_rgba(0,0,0,0.8)] hover:shadow-[0_30px_100px_rgba(212,175,55,0.2)] transition-all duration-700 overflow-hidden backdrop-blur-sm">

                    {{-- Image Slider --}}
                    <div class="relative">
                        @if (!empty($tour['images']))
                            <div class="swiper mySwiper w-full h-[35rem] lg:h-[40rem]">
                                <div class="swiper-wrapper">
                                    @foreach ($tour['images'] as $image)
                                        <div class="swiper-slide relative group">
                                            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-yellow-400/10 to-transparent opacity-0 group-hover:opacity-100 group-hover:animate-shimmer z-10 transition-opacity duration-500"></div>
                        ...
                        {{-- Floating Info Badge --}}
                        <div class="absolute top-8 left-8 backdrop-blur-xl bg-neutral-900/70 border border-white/10 px-5 py-2 md:py-3 rounded-2xl flex items-center gap-3 animate-pulse">
                        ...
                        {{-- Rating Badge --}}
                        <div class="absolute top-8 right-8 backdrop-blur-xl bg-neutral-900/70 border border-white/10 px-4 py-2 rounded-full flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-yellow-400" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path d="M12 2l2.4 7.4h7.6l-6 4.6 2.3 7-6.3-4.6-6.3 4.6 2.3-7-6-4.6h7.6z" />
                            </svg>
                    ...
                    <div class="p-10 lg:p-16 space-y-10">
                        ...
                        <div class="space-y-6 animate-fade-in" style="animation-delay: 0.3s;">
                            <div class="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <h1 class="text-base md:text-sm md:text-lg lg:text-xl lg:text-2xl md:text-sm md:text-lg lg:text-xl md:text-lg md:text-base md:text-sm md:text-lg lg:text-xl lg:text-2xl lg:text-3xl lg:text-4xl lg:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-amber-300 to-yellow-500 leading-tight">
                                        {{ $tour['name'] }}
                                    </h1>
                                </div>
                            </div>

                            <p class="text-gray-300 text-sm md:text-lg lg:text-xl leading-relaxed pl-6 border-l-4 border-yellow-500/50 font-light">
                                {{ $tour['description'] ?? 'ไม่มีรายละเอียดทัวร์' }}
                            </p>
                        </div>

                        {{-- Features Grid --}}
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 animate-fade-in" style="animation-delay: 0.4s;">
                            @php
                                $features = [
                                    [
                            ...
                            <div class="backdrop-blur-xl bg-neutral-900/70 border border-white/10 p-6 rounded-2xl group hover:bg-yellow-600/10 hover:border-yellow-500/50 transition-all duration-500 cursor-pointer">
                                <div class="flex items-center gap-4">
                                    <div class="w-14 h-14 bg-yellow-500/20 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300">
                        ...
                        <div class="animate-fade-in" style="animation-delay: 0.5s;">
                            <h3 class="text-base md:text-sm md:text-lg lg:text-xl lg:text-2xl font-bold text-yellow-400 mb-6 flex items-center gap-3">
                            ...
                            <div class="flex flex-wrap gap-3 mt-4">
                                @if (!empty($tour['Highlights'][0]))
                                    @foreach (explode(',', $tour['Highlights'][0]) as $item)
                                        <span class="relative overflow-hidden px-4 md:px-6 py-2 md:py-3 backdrop-blur-xl bg-neutral-900/70 border border-white/10 text-yellow-400 text-sm font-semibold rounded-2xl flex items-center gap-2 hover:scale-105 transition-transform duration-300 cursor-pointer">
                        ...
                        <div class="backdrop-blur-xl bg-neutral-900/70 border border-white/10 rounded-2xl md:rounded-3xl p-4 md:p-8 lg:p-10 animate-fade-in" style="animation-delay: 0.6s;">
                            <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
                                <div class="flex-1">
                                    <p class="text-gray-400 text-sm uppercase tracking-widest mb-2">ราคาเริ่มต้น</p>
                                    <div class="flex items-baseline gap-3">
                                        <p class="tour-price text-base md:text-sm md:text-lg lg:text-xl lg:text-2xl md:text-sm md:text-lg lg:text-xl md:text-lg md:text-base md:text-sm md:text-lg lg:text-xl lg:text-2xl lg:text-3xl lg:text-4xl lg:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-300">
                                            {{ number_format($tour['price'] ?? 0, 0) }}
                                        </p>
                                        <span class="text-base md:text-sm md:text-lg lg:text-xl lg:text-2xl text-gray-400 font-light">บาท</span>
                                    </div>
                                ...
                                <div class="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                                    <a href="#"
                                        ...
                                        <span class="absolute inset-0 bg-gradient-to-r from-amber-500 to-yellow-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Counter Animation สำหรับราคา
            const priceElement = document.querySelector('.tour-price');
            if (priceElement) {
                const finalPrice = parseInt(priceElement.textContent.replace(/,/g, ''));
                const duration = 2000;
                const stepTime = 30;
